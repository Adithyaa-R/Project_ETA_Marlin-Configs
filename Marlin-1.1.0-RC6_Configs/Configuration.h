...
#define CUSTOM_MACHINE_NAME "ETA"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  //#define  DEFAULT_Kp 22.2//defaults
...
//#define USE_YMAX_PLUG //23-3-17 disbled y and max endstops
...
//   - normally-open switches to 5V and D32.//ARD- Mine connects to 5V & 59 @aux2
//
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,100.6}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {250, 250, 4, 70}    // (mm/sec)
...
// controller and SD support - http://repraporg/wiki/Mini_panel
//
//#define MINIPANEL
